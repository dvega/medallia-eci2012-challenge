...
public interface Classifier {
	 ...
	 *
	 * @return The predicted Sentiment magnitude. -1.0 => {@link Sentiment#NEGATIVE}, 0.0 => {@link Sentiment#NEUTRAL},
	 *         +1.0 => {@link Sentiment#POSITIVE} . Any in between values means in between prediction.
	 *         <p>
